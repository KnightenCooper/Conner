...
var walk = function() {
  var documentation_text = document.getElementById("documentation_id");// gets the current documentation
  // below code adds the additional documentation to the current documentation
  documentation_text.innerHTML = documentation_text.innerHTML + "I asked Conner if he wanted to go for a walk. Conner signed yes. I encouraged Conner to get a coat, and gloves. " + 
